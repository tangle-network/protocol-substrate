...
use frame_support::{
	parameter_types,
	traits::{ConstU8, GenesisBuild, Nothing},
	PalletId,
};
...
pub fn assert_last_event<T: pallet_anchor::Config>(
	generic_event: <T as pallet_anchor::Config>::Event,
) {
...
pub fn new_test_ext() -> sp_io::TestExternalities {
	...
	default_zero_root_hashes.push(get_bytes_from_hex(
	...
	let bn254_x5_3_params = setup_params::<ark_bn254::Fr>(Curve::Bn254, 5, 3);
