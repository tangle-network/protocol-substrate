...
import { PalletAssetRegistryAssetType, SpConsensusBabeDigestsNextConfigDescriptor, SpConsensusSlotsEquivocationProof, SpSessionMembershipProof, SpWeightsWeightV2Weight, PalletDemocracyConviction, FrameSupportPreimagesBounded, PalletDemocracyMetadataOwner, PalletDemocracyVoteAccountVote, SpNposElectionsSupport, SpNposElectionsElectionScore, PalletElectionProviderMultiPhaseRawSolution, PalletElectionProviderMultiPhaseSolutionOrSnapshotSize, PalletElectionsPhragmenRenouncing, SpFinalityGrandpaEquivocationProof, PalletImOnlineHeartbeat, PalletImOnlineSr25519AppSr25519Signature, WebbPrimitivesRuntimeElement, PalletMultisigTimepoint, PalletNominationPoolsBondExtra, PalletNominationPoolsClaimPermission, PalletNominationPoolsConfigOpU128, PalletNominationPoolsConfigOpU32, PalletNominationPoolsPoolState, PalletNominationPoolsConfigOpAccountId32, WebbStandaloneRuntimeProxyType, WebbProposalsHeaderResourceId, PalletRelayerRegistryResourceInfo, WebbStandaloneRuntimeSessionKeys, PalletStakingRewardDestination, PalletStakingPalletConfigOpU128, PalletStakingPalletConfigOpU32, PalletStakingPalletConfigOpPercent, PalletStakingPalletConfigOpPerbill, PalletStakingValidatorPrefs, WebbStandaloneRuntimeOriginCaller, WebbPrimitivesVanchorProofData, WebbPrimitivesVanchorExtData } from '@polkadot/types/lookup';
