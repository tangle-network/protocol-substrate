...
async fn test_mixer() -> Result<(), Box<dyn std::error::Error>> {
	...
	let pk_bytes =
		include_bytes!("../../protocol-substrate-fixtures/mixer/bn254/x5/proving_key_uncompressed.bin");
	let vk_bytes =
		include_bytes!("../../protocol-substrate-fixtures/mixer/bn254/x5/verifying_key_uncompressed.bin");
